...
define gui.text_font = "rounded-x-mplus-1c-black.ttf"

## キャラクターの名前に使われるフォント。
define gui.name_text_font = "rounded-x-mplus-1c-bold.ttf"

## ゲームメニューなどのインターフェースに使われるテキストのフォント。
define gui.interface_text_font = "rounded-x-mplus-1c-bold.ttf"
